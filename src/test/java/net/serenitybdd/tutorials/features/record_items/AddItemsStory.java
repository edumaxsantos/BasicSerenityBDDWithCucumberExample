package net.serenitybdd.tutorials.features.record_items;
...
public class AddItemsStory {
    ...
    public void should_be_able_to_add_additional_todo_items() {
        ...
        then(justin).should(seeThat(TheTodoItems.displayed(), hasItems("Feed the cat", "take out the garbage", "Walk the dog")));
    }
}
